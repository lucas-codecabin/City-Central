...
import GridEditServiceLocation from "~/components/GridEditServiceLocation.vue";
</script>

<template>
  <main class="grid grid-cols-[300px_1fr] bg-primary-950 pr-8">
    <SidebarMenu />
